...
def get_workflow_mermaid() -> str:
    ...
    mermaid = """graph TD
    A["🔍 SQL Agent<br/>Generate & Execute Query"] --> B{Query<br/>Success?}
    B -->|Yes| C["📊 Visualization Agent<br/>Create Interactive Chart"]
    B -->|No| A
    C --> D["💡 Insights Agent<br/>Generate Business Recommendations"]
    D --> E["✅ Complete"]
...
def visualize_workflow_ascii() -> str:
    """Return ASCII representation of the workflow"""
    ascii_art = """
    ╔════════════════════════════════════════════════════════════════╗
    ║          Multi-Agent SaaS Metrics Analyzer Workflow            ║
    ╚════════════════════════════════════════════════════════════════╝
    ...
    Timeline: 10-20 seconds per analysis
    Timeout: 45 seconds with 2 auto-retries
    """
    return ascii_art
